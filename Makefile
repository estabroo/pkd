...
dist:
	...
	@cp -a include* example.ipt_pkd.ini knock.py GPLv2 Changelog DISCLAIMER README knock.c libipt_pkd.c pkd.c ipt_pkd.h Makefile vyatta-5 knock_csharp pkd-${PKD_VERSION}
